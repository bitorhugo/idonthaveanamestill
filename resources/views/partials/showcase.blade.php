            ...
            <div class="col-lg-3 col-md-6 col-sm-12 pb-1">
                <div class="card product-item border-0 mb-4">
                    <div class="card-header product-img position-relative overflow-hidden bg-transparent border p-0">
                        @if(Storage::disk('media')->exists('App/Models/Card/' . $card->card_id))
                            <img src="{{asset('storage/media/App/Models/Card/'.$card->card_id.'/conversion/0-thumb.jpg')}}" alt='image'>
                        @else
                    ...
                    <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                        ...
                        <div class="d-flex justify-content-center">
                            <h6>{{$card->price - ($card->price * $card->discount_amount)}}</h6><h6 class="text-muted ml-2"><del class="p-r-5">{{$card->price}}</del>EUR</h6>
                        </div>
                    </div>
